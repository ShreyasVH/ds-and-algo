...
public class Problem700085a
{
	...
	public LinkedListNode zigZag(LinkedListNode head) {
        ...
        {
            if(
                (direction && Integer.parseInt(String.valueOf(curr.val)) > Integer.parseInt(String.valueOf(curr.next.val)))
                ||
                (!direction && Integer.parseInt(String.valueOf(curr.val)) < Integer.parseInt(String.valueOf(curr.next.val)))
            )
            {
                int temp = Integer.parseInt(String.valueOf(curr.val));
                curr.val = Integer.parseInt(String.valueOf(curr.next.val));
                curr.next.val = temp;
            }
